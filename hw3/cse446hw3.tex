...
\begin{figure}[h]
  \centering
  \subfloat[best hyperparameters training]{\includegraphics[width=100mm]{../hw3-code/results/a6b/a6_b_tb.png}}
  \subfloat[best hyperparameters validation]{\includegraphics[width=100mm]{../hw3-code/results/a6b/a6_b_vb.png}}
\end{figure}
