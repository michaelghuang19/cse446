...
\begin{figure}[h]
  \centering
  \subfloat[training]{\includegraphics[width=90mm]{../hw3-code/results/a6_a_t0.png}}
  \subfloat[validation]{\includegraphics[width=90mm]{../hw3-code/results/a6_a_v0.png}}
\end{figure}

\begin{figure}[h]
  \centering
  \subfloat[training]{\includegraphics[width=90mm]{../hw3-code/results/a6_a_t1.png}}
  \subfloat[validation]{\includegraphics[width=90mm]{../hw3-code/results/a6_a_v1.png}}
\end{figure}

\begin{figure}[t]
  \centering
  \subfloat[training]{\includegraphics[width=90mm]{../hw3-code/results/a6_a_t2.png}}
  \subfloat[validation]{\includegraphics[width=90mm]{../hw3-code/results/a6_a_v2.png}}
\end{figure}
\newpage
...
\begin{figure}[h]
  \centering
  \subfloat[best hyperparameters training]{\includegraphics[width=100mm]{../hw3-code/results/a6_a_tb.png}}
  \subfloat[best hyperparameters validation]{\includegraphics[width=100mm]{../hw3-code/results/a6_a_vb.png}}
\end{figure}
...
% \begin{figure}[h]
%   \centering
%   \subfloat[training]{\includegraphics[width=100mm]{../hw3-code/results/.png}}
%   \subfloat[validation]{\includegraphics[width=100mm]{../hw3-code/results/.png}}
% \end{figure}
...
% \begin{figure}[h]
%   \centering
%   \subfloat[best hyperparameters training]{\includegraphics[width=100mm]{../hw3-code/results/.png}}
%   \subfloat[best hyperparameters validation]{\includegraphics[width=100mm]{../hw3-code/results/.png}}
% \end{figure}
